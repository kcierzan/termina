...
let s:p.normal.left     = [ [ s:black, s:blue ], [ s:black, s:dark_yellow ], [ s:black, s:dark_red ], [ s:blue, s:black ] ]
let s:p.insert.left     = [ [ s:black, s:green ], [ s:black, s:dark_yellow ], [ s:black, s:dark_red ], [ s:green, s:black ] ]
let s:p.visual.left     = [ [ s:black, s:magenta ], [ s:black, s:dark_yellow ], [ s:black, s:dark_red ], [ s:magenta, s:black ] ]
let s:p.replace.left    = [ [ s:black, s:red ], [ s:black, s:dark_yellow ], [ s:black, s:dark_red ], [ s:magenta, s:dark_red ] ]
let s:p.inactive.left   = [ [ s:blue, s:dark1 ], [ s:dark_yellow, s:dark1 ], [ s:dark_red, s:dark1 ], [ s:black, s:dark1 ] ]

let s:p.normal.right    = [ [ s:black, s:magenta ], [ s:black, s:cyan ] ]
let s:p.insert.right    = [ [ s:black, s:magenta ], [ s:black, s:cyan ] ]
let s:p.visual.right    = [ [ s:black, s:magenta ], [ s:black, s:cyan ] ]
let s:p.replace.right   = [ [ s:black, s:magenta ], [ s:black, s:cyan ] ]
let s:p.inactive.right  = [ [ s:magenta, s:black ], [ s:cyan, s:black ] ]

let s:p.normal.middle   = [ [ s:light1, s:black ] ]
let s:p.inactive.middle = [ [ s:light0, s:dark3 ] ]
